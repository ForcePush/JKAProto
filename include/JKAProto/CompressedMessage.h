...
public:
    ...
    void readDeltaUsercmd(const JKA::usercmd_t *from, JKA::usercmd_t *to);
    void readDeltaUsercmdKey(int32_t key, const JKA::usercmd_t *from, JKA::usercmd_t *to);
    void writeDeltaUsercmd(const JKA::usercmd_t *from, const JKA::usercmd_t *to);
    void writeDeltaUsercmdKey(int32_t key, const JKA::usercmd_t *from, const JKA::usercmd_t *to);

    void readDeltaEntity(const JKA::entityState_t *from, JKA::entityState_t *to, int number);
    void writeDeltaEntity(const JKA::entityState_t *from, const JKA::entityState_t *to, bool force);

    void readDeltaPlayerstate(const JKA::playerState_t *from, JKA::playerState_t *to, bool isVehiclePS = false);
    void writeDeltaPlayerstate(const JKA::playerState_t *from, const JKA::playerState_t *to, bool isVehiclePS);
